...
def loadata(name, compressed=False):
    ...
    if name == 'IP':
        ...
        dat = sio.loadmat(os.path.join(os.path.dirname(__file__), 'Data', 'run04' + comp + '.mat'))['run04']
        label = sio.loadmat(os.path.join(os.path.dirname(__file__), 'Data', 'run04_gt.mat'))['run04_gt']
        return dat, label
